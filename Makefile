...
OBJECTS = a6test.o strategy.o dice.o board.o player.o tile.o subject.o vertex.o edge.o 
DEPENDS = ${OBJECTS:.o=.d}
EXEC = ctor
...
a6test.o: a6test.cc board.h tile.h player.h vertex.h edge.h subject.h observer.h dice.h strategy.h
