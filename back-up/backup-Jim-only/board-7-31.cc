...
string Board::ttype(int pos) {
    ...
    switch( tileType ) {
        ...
        case 'P':
            return "  PARK   "; break;
        default:
            throw "WRONG RESOURCE TYPE FOR Board::ttype"; break;
    }
}
...
void Board::printBoard() {
    ...
    cout << "                           "<<" 1"<<"    0   "<<" 2"<<endl;
    cout << "                            |"<<"  BRICK  "<<"|"<<endl;
    cout << "                "<<"| 2|"<<"--"<<" 3"<<"--"<<"| 3|"<<"  "<<" 4"<<"  "<<"| 4|"<<"--"<<" 4"<<"--"<<"| 5|"<<endl;
    cout << "                  |         |         |         |";
    cout << "                "<<"  5"<<"    1   "<<" 6"<<"        "<<" 7"<<"    2   "<<" 8"<<endl;
    cout << "                  |"<<"  HEAT   "<<"|         |"<<"  HEAT   "<<"|"<<endl;
    cout << "      "<<"| 6|"<<"--"<<" 9"<<"--"<<"| 7|"<<"  "<<" 6"<<"  "<<"| 8|"<<"--"<<"10"<<"--"<<"| 9|"<<"  "<<" 5"<<"  "<<"|10|"<<"--"<<"11"<<"--"<<"|11|"<< endl;
    cout << "        |         |         |         |         |         |"<<endl;
    cout << "       12"<<"    3   "<<"13"<<"        "<<"14"<<"    4   "<<"15"<<"        "<<"16"<<"    5   "<<"17"<<endl;
    cout << "        "<<"|  GLASS  |"<<"         "<<"| ENERGY  |"<<"         "<<"|  WIFI   |" << endl;
    cout << "      "<<"|12|"<<" "<<"  8"<<"  "<<"|13|"<<"--"<<"18"<<"--"<<"|14|"<<" "<<" 11"<<"  "<<"|15|"<<"--19--"<<"|16|"<<"  "<<"12"<<"  "<<"|17|"<<endl;
    cout << "        |         |         |         |         |         |"<<endl;
    cout << "       20        21    6   22        23    7   24        25" << endl;
    cout << "        |         | ENERGY  |         |  PARK   |         |" << endl;
    cout << "      |18|--26--|19|   9  |20|--27--|21|      |22|--28--|23|" << endl;
}
